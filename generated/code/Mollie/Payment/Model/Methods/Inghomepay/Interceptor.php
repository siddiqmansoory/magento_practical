<?php
namespace Mollie\Payment\Model\Methods\Inghomepay;

/**
 * Interceptor class for @see \Mollie\Payment\Model\Methods\Inghomepay
 */
class Interceptor extends \Mollie\Payment\Model\Methods\Inghomepay implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\Api\ExtensionAttributesFactory $extensionFactory, \Magento\Framework\Api\AttributeValueFactory $customAttributeFactory, \Magento\Payment\Helper\Data $paymentData, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Payment\Model\Method\Logger $logger, \Magento\Sales\Model\OrderRepository $orderRepository, \Magento\Sales\Model\ResourceModel\Order\CollectionFactory $orderFactory, \Mollie\Payment\Model\Client\Orders $ordersApi, \Mollie\Payment\Model\Client\Payments $paymentsApi, \Mollie\Payment\Helper\General $mollieHelper, \Magento\Checkout\Model\Session $checkoutSession, \Magento\Framework\Api\SearchCriteriaBuilder $searchCriteriaBuilder, \Magento\Framework\View\Asset\Repository $assetRepository, \Magento\Framework\App\ResourceConnection $resourceConnection, \Mollie\Payment\Config $config, \Mollie\Payment\Service\Mollie\Timeout $timeout, ?\Magento\Framework\Model\ResourceModel\AbstractResource $resource = null, ?\Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $registry, $extensionFactory, $customAttributeFactory, $paymentData, $scopeConfig, $logger, $orderRepository, $orderFactory, $ordersApi, $paymentsApi, $mollieHelper, $checkoutSession, $searchCriteriaBuilder, $assetRepository, $resourceConnection, $config, $timeout, $resource, $resourceCollection, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'startTransaction');
        if (!$pluginInfo) {
            return parent::startTransaction($order);
        } else {
            return $this->___callPlugins('startTransaction', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadMollieApi');
        if (!$pluginInfo) {
            return parent::loadMollieApi($apiKey);
        } else {
            return $this->___callPlugins('loadMollieApi', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMollieApi');
        if (!$pluginInfo) {
            return parent::getMollieApi($storeId);
        } else {
            return $this->___callPlugins('getMollieApi', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'processTransaction');
        if (!$pluginInfo) {
            return parent::processTransaction($orderId, $type, $paymentToken);
        } else {
            return $this->___callPlugins('processTransaction', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'orderHasUpdate');
        if (!$pluginInfo) {
            return parent::orderHasUpdate($orderId);
        } else {
            return $this->___callPlugins('orderHasUpdate', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function createShipment(\Magento\Sales\Model\Order\Shipment $shipment, \Magento\Sales\Model\Order $order)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'createShipment');
        if (!$pluginInfo) {
            return parent::createShipment($shipment, $order);
        } else {
            return $this->___callPlugins('createShipment', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'updateShipmentTrack');
        if (!$pluginInfo) {
            return parent::updateShipmentTrack($shipment, $track, $order);
        } else {
            return $this->___callPlugins('updateShipmentTrack', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'cancelOrder');
        if (!$pluginInfo) {
            return parent::cancelOrder($order);
        } else {
            return $this->___callPlugins('cancelOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'createOrderRefund');
        if (!$pluginInfo) {
            return parent::createOrderRefund($creditmemo, $order);
        } else {
            return $this->___callPlugins('createOrderRefund', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOrderIdByTransactionId');
        if (!$pluginInfo) {
            return parent::getOrderIdByTransactionId($transactionId);
        } else {
            return $this->___callPlugins('getOrderIdByTransactionId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIssuers');
        if (!$pluginInfo) {
            return parent::getIssuers($mollieApi, $method, $issuerListType);
        } else {
            return $this->___callPlugins('getIssuers', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPaymentMethods($storeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getPaymentMethods($storeId);
        } else {
